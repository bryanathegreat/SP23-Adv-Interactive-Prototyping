...
while True:
    if(ticks_ms() > sensor_timer + 200):
        ...
        if(button_pin.value() == 0):
            ...
            print('sending.. ' + send_str)
            espnow.espnow_send_str(1, send_str)
            # change the program state on the other board to "working mode"
            program_state = 'MOTION'
            # print(program_state)
        if(program_state == 'MOTION'):
                    # make the tilt toggle
            last_tilt_state = current_tilt_state
            # print(last_tilt_state)
            # print(current_tilt_state)
            # print(acc_x)
            if(0.5 <acc_x < 1.2):
            ...
            if(tilt_count == 3):
                ...
                for index in range(15):
                    ...
                    neopixel_strip.write()
                    sleep_ms(76)
                # rgb.set_screen([0,0,0,0,0,0,0,0xffffff,0xffffff,0,0,0,0xffffff,0xffffff,0,0,0,0,0xffffff,0,0,0,0,0,0])
                # pass
            elif(tilt_count == 4):
                send_str = "tilt:4"
                print('sending.. ' + send_str)
                ...
                for index in range(20):
                    ...
                    neopixel_strip.write()
                    sleep_ms(64)
                # rgb.set_screen([0,0xffffff,0,0,0,0,0xffffff,0xffffff,0xffffff,0,0,0xffffff,0xffffff,0xffffff,0,0,0xffffff,0xffffff,0xffffff,0,0,0,0,0,0])
                # pass
            elif(tilt_count== 5):
                send_str = "tilt:5"
                print('sending.. ' + send_str)
                ...
                for index in range(25):
                    ...
                    neopixel_strip.write()
                    sleep_ms(52)
                # rgb.set_screen([0,0xffffff,0xffffff,0xffffff,0xffffff,0,0xffffff,0xffffff,0xffffff,0xffffff,0,0xffffff,0xffffff,0xffffff,0xffffff,0,0xffffff,0xffffff,0xffffff,0,0,0,0,0,0])
                # pass
            elif(tilt_count == 6):
                send_str = "tilt:6"
                print('sending.. ' + send_str)
